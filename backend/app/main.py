    ...
    try:
        if db.query(Loan).count() == 0:
            ...
            crud.create_loan(
                ...
                biller_name="State Bank of India",
                loan_account_number="XXXXXXXXXXXX9999",
                customer_name="Aarav Sharma",
                type="LOAN",
                category="Personal Loan",
            ...
            crud.create_loan(
                ...
                biller_id="HDFC00000NAT01",
                biller_name="HDFC Bank",
                loan_account_number="XXXXXXXXXXXX1122",
                customer_name="Aarav Sharma",
                type="CREDIT_CARD",
            ...
            crud.create_loan(
                ...
                biller_id="SBIL00000NAT03",
                biller_name="State Bank of India",
                loan_account_number="XXXXXXXXXXXX2233",
            ...
            crud.create_loan(
                ...
                biller_id="ADIT00000NAT02",
                biller_name="Aditya Birla Finance",
                loan_account_number="XXXXXXXXXXXX3344",
                customer_name="Priya Patel",
                type="LOAN",
                category="Personal Loan",
