              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {activeMandates.map((m) => (
                  <div 
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = 'translateY(-4px) scale(1.01)'
                      e.currentTarget.style.boxShadow = '0 12px 30px rgba(9, 9, 11, 0.06)'
                      e.currentTarget.style.borderColor = 'rgba(9, 9, 11, 0.2)'
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = 'none'
                      e.currentTarget.style.boxShadow = 'none'
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', opacity: 0.75 }}>
                {historyMandates.map((m) => (
                  <div 
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.transform = 'translateY(-4px) scale(1.01) rotateX(1.5deg) rotateY(-1.5deg)'
                      e.currentTarget.style.boxShadow = '0 12px 30px rgba(9, 9, 11, 0.06)'
                      e.currentTarget.style.borderColor = 'rgba(9, 9, 11, 0.2)'
                    }}
                    onMouseLeave={(e) => {
