...
export default function Settlement() {
  ...
  useEffect(() => {
    ...
    const { preSelectedLoanId, preSelectedLoan, viewReceiptLoan } = location.state || {}

    // Direct printable receipt view check
    if (viewReceiptLoan) {
      setMobile(u.mobile)
      setSelectedLoan(viewReceiptLoan)
      setSettledResult({
        success: true,
        ndcId: `NDC-PREVIEW-${viewReceiptLoan.loanAccountNumber || viewReceiptLoan.loan_account_number}`,
        settledAt: viewReceiptLoan.settledAt || viewReceiptLoan.date || new Date().toISOString(),
        settledAmount: viewReceiptLoan.settledAmount || viewReceiptLoan.amount,
        loan: {
          loanAccountNumber: viewReceiptLoan.loanAccountNumber || viewReceiptLoan.loan_account_number,
          billerName: viewReceiptLoan.billerName || viewReceiptLoan.biller_name || 'Lender Bank',
          customerName: viewReceiptLoan.customerName || viewReceiptLoan.customer_name || (u.first_name + ' ' + u.last_name)
        }
      })
      setStep('SUCCESS')
      return
                  ...
                  return (
                    <div 
                      ...
                      style={{ 
                        ...
                        padding: '1.8rem', 
                        borderLeft: `5px solid ${statusBadgeColor}`,
                    ...
                    >
                      <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', marginBottom: '1.8rem' }}>
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid var(--glass-border)', paddingTop: '0.8rem', fontSize: '0.8rem' }}>
                            <div>
        ...
        <div className="animate-fade-in text-center">
          ...
          <div className="ndc-certificate-wrapper" style={{ margin: '2rem auto', maxWidth: '700px' }}>
            <div className="ndc-card" style={{
              ...
              {/* Signatures & Stamp */}
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem', marginTop: '3.5rem', borderTop: '1px dashed #d1d5db', paddingTop: '1.5rem', fontFamily: 'sans-serif' }}>
